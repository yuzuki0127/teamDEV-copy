...
<div class="narrow-set">
    <div class="narrowList">
        <div class="narrow-info">
            ...
            <!-- 表示件数改善の必要あり -->
            <p class="narrow-figure"><?= count($filteredAgencies); ?>件</p>
            <p class="narrow-searchCon">現在の検索条件</p>
            <div class="narrow-clearButton">
                <!-- <button class="narrow-clearBtn">条件クリア</button> -->
                <a href="../index.php" class="narrow-clearBtn">条件クリア</a>
            </div>
            <!-- <form action="index.php" method="POST" class="narrow-clearButton">
                <button type="button" id="narrow-search" class="narrow-clearBtn">条件クリア</button>
            </form> -->
        </div>
