<?php
$agencies = $dbh->query('SELECT * FROM agency WHERE approval = 0')->fetchAll(PDO::FETCH_ASSOC);
...
<section class="">
    <div class="new-possible">
        <p class="new-possibleTitle">新規エージェンシー認証</p>
            ...
            <?php if (count($agencies) === 0) {
                ...
                foreach ($agencies as $i => $agency) { ?>
                    <li class="agency-infoItem">
                        ...
                        <form action="index.php" method="POST" class="agency-selectButton open-button">
                            <input class="agency-rejectBtn" type="submit" name="reject<?= $agency["id"]; ?>" value="拒否">
                            <input class="agency-approvalBtn" type="submit" name="approval<?= $agency["id"]; ?>" value="承認">
                        </form>
